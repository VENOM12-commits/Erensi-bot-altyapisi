...
module.exports.run = async(client, message, args, tools) => {
  ...
  if(!kanal) return message.reply({ content: "Bir sayı yazmalısın.  Örnek `!sayaç #kanal 80`", allowedMentions: { repliedUser: false }})
  if(!sayi) return message.reply({ content: "Bir sayı yazmalısın.  Örnek `!sayaç #kanal 80    `", allowedMentions: { repliedUser: false }})
  ...
  .setColor("Red")
  .setDescription(` Ayarlanan Kanal: ${kanal} Ayarlanan Sayı: ${sayi} Sayaç Sistemi Aktif Edildi, Hedefimize Ulaşmak İçin **${sayi - message.guild.memberCount}** Kişi Kaldı 
   ║
   ╚▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ `)
